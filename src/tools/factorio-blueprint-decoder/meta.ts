...
export const meta: ToolMeta = {
  ...
  options: [
    ...
    { kind: 'boolean', id: 'stripTrees', label: 'Strip: remove trees, rocks and other environment entities', default: true },
    { kind: 'boolean', id: 'stripRequests', label: 'Strip: clear all module and item requests', default: false },
