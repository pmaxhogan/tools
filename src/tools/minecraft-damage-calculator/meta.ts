...
export const meta: ToolMeta = {
  ...
  searchTerms: [
    ...
    "minecraft pvp damage calculator",
    "how much armor do i need minecraft",
    "diamond armor damage reduction",
    "wind charge mace combo",
    "safe fall distance minecraft",
    "how many hearts of fall damage",
    "netherite armor vs diamond armor",
    "hits to kill calculator",
    "armor toughness calculator",
    "combat damage calculator minecraft",
  ],
  input: "none",
  ...
  options: [
    ...
    },
    {
      kind: "number",
      id: "protection",
      label: "Protection levels (all pieces)",
      default: 0,
      min: 0,
      max: 16,
      step: 1,
