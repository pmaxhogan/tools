...
export const meta: ToolMeta = {
  ...
  copy: {
    what: "Reads any CSS color and rewrites it in every syntax: hex, rgb, hsl, hwb, oklch, oklab, lab and lch, plus the nearest of the 148 CSS color names. It also checks WCAG 2 contrast, either for one color against white and black or between two colors you supply, and builds palettes in OKLCH: complementary, analogous, triadic, tetradic, split complementary, five tints, five shades, and a numbered scale from 50 to 950. Colors from outside the sRGB gamut are fitted by reducing chroma while lightness and hue hold, and the result tells you when that happened.",
    how: 'Paste a color such as #663399, rgb(102 51 153), oklch(0.44 0.16 303) or rebeccapurple and the conversion rows appear straight away. Switch the mode to "Contrast check" and write two colors as "#777777 on #ffffff" or "#777777, #ffffff" to get the ratio and the AA and AAA verdicts for normal and large text. Switch to "Palette" and pick a family to generate swatches, each with its hex and its OKLCH. Every row has a copy button, and the URL carries what you see so you can share it.',
    why: "Most color converters online run one conversion per page, wrap it in ad slots, and stop at hex, rgb and hsl. This one does the modern spaces too, gets the white points right, gamut maps instead of silently clipping, and rotates palette hues in OKLCH so a generated scheme keeps an even perceived lightness. Your inputs never leave your device, and there is no signup or swatch limit.",
    faq: [
      {
      ...
      {
        q: "Is my color or palette uploaded anywhere?",
