...
export const meta: ToolMeta = {
  ...
  searchTerms: [
    ...
    "minecraft enchantment book calculator",
    "book combining cost calculator",
    "xp levels for enchanting",
    "how many levels to combine enchantments",
    "anvil merge order",
    "minecraft repair calculator",
    "prior work penalty calculator",
    "too expensive calculator",
  ],
