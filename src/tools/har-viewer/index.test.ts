...
describe('har-viewer renderWaterfall', () => {
  ...
  it('survives a zero length capture without dividing by zero', () => {
    const flat = parseHar(
      buildHar([
        { start: 0, time: 0, url: 'https://a.test/', status: 200, mimeType: 'text/html', size: 0, bodySize: 0 },
        { start: 0, time: 0, url: 'https://a.test/b', status: 200, mimeType: 'text/html', size: 0, bodySize: 0 },
      ]),
    );
