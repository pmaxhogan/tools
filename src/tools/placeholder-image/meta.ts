...
export const meta: ToolMeta = {
  ...
  options: [
    ...
    { kind: 'text', id: 'background', label: 'Background color', default: '#e2e8f0', placeholder: '#e2e8f0' },
    { kind: 'text', id: 'foreground', label: 'Text color', default: '#64748b', placeholder: '#64748b' },
    {
      kind: 'text',
      id: 'label',
      label: 'Label',
