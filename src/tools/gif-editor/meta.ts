...
export const meta: ToolMeta = {
  ...
  options: [
    ...
    { kind: 'number', id: 'fps', label: 'Optimize: frames per second', default: 15, min: 1, max: 50, step: 1 },
    { kind: 'number', id: 'colors', label: 'Optimize: colors in the palette', default: 128, min: 4, max: 256, step: 1 },
