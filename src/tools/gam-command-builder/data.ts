...
export type RecipeCategory =
  "users" | "groups" | "drive" | "gmail" | "calendar" | "org-units" | "licenses" | "reports";
...
const OU_SYNONYMS =
  "GAM accepts ou, org and orgunitpath as the same argument, so pick whichever reads best.";
...
const P = {
  ...
  sku: {
    name: "sku",
    description:
      "A license SKU id or one of GAM's aliases, such as 1010020028, wsbizstan, 1010020020, wsentplus or Google-Apps-Unlimited.",
    example: "1010020028",
    required: true,
  },
...
export const RECIPES: Recipe[] = [
  ...
  },
  {
    ...
    params: [P.user],
    notes: [
      "This can be slow. The Licensing API has no call that lists a user's licenses, so GAM probes every SKU it knows one at a time, which burns quota. Run gam show configlicenseskus once and save the result into license_skus in gam.cfg to limit the probing to SKUs you actually own.",
...
gam user <user> delete license <sku>`,
    params: [
      ...
      },
      {
        name: "ou",
        description:
          "An org unit you use to park departed staff, with sign in and sharing locked down.",
        example: "/Leavers",
        required: true,
      },
      P.sku,
    ...
    notes: [
      ...
      "Do not remove the license until gam show datatransfers reports the transfer finished. A half transferred Drive is not something you can restart cleanly.",
  ...
  // ----------------------------------------------------------------- groups
  {
    ...
    params: [
      ...
      },
      {
        ...
        example: "Everyone in the sales organization",
        required: false,
      },
    ],
    notes: [
  ...
  },
  {
    ...
    notes: [
      ...
      "Watch it finish with gam show datatransfers, and do not remove the source account's license until it has.",
    ],
  },
  {
  ...
  {
    id: "shareddrive-list",
    task: "List every shared drive in the organization",
    category: "drive",
    template: "gam print shareddrives",
    params: [],
    notes: [
      "Run as an admin this lists the whole organization. gam user <user> print shareddrives lists only the drives that user is in, unless you add adminaccess.",
  ...
  },
  {
    ...
    params: [
      ...
      {
        name: "role",
        description: "organizer, fileorganizer, writer, commenter or reader. Case does not matter.",
...
gam user <user> forward on <disposition> <forwardto>`,
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        example:
          "I am away and will reply when I am back. For anything urgent, mail sales@example.com.",
        required: true,
      },
      {
        name: "startdate",
  ...
  },
  {
    ...
    category: "gmail",
    template: "gam user <user> signature htmlfile <sigfile> replace FirstName field:name.givenname",
    params: [
      P.user,
      {
        name: "sigfile",
  ...
  },
  {
    ...
    notes: [
      ...
      "Meetings this person organized disappear from everyone else's calendar too.",
    ],
    destructive: true,
  },
  {
  ...
  {
    id: "license-assign",
    task: "Assign a license to a user",
    category: "licenses",
  ...
  {
    id: "license-remove",
    task: "Remove a license from a user",
    category: "licenses",
    template: "gam user <user> delete license <sku>",
    params: [P.user, P.sku],
    notes: [
      "Removing a license takes away the services it paid for, which can mean a mailbox becomes unreachable. Do this after any data transfer, never before.",
  ...
  {
    id: "license-swap",
    task: "Move a user from one license to another",
    category: "licenses",
    ...
    notes: [
      ...
      "Add archive to archive the user as part of the swap, which is the route for archiving somebody who holds a license that cannot be archived directly.",
    ],
  },
  {
    id: "license-assign-ou",
    task: "Assign a license to everyone in an org unit",
    category: "licenses",
  ...
  {
    id: "license-sync-ou",
    task: "Make everyone in an org unit hold exactly one license SKU",
    category: "licenses",
    ...
    notes: [
      ...
      "onesku confines it to the SKU you named. allskus lets it remove any other license it finds, which is a much bigger swing.",
  ...
  {
    id: "license-print",
    task: "List every license assignment in the domain",
    category: "licenses",
  ...
  },
  {
    ...
    task: "Count how many seats of one license SKU are in use",
    category: "licenses",
  ...
  },
  {
    ...
    task: "Find which license SKUs your domain owns, so gam info user stops crawling",
    category: "licenses",
    template: "gam show configlicenseskus",
    params: [],
    notes: [
      "Added in GAM7 and not present in GAMADV-XTD3.",
      "The Licensing API cannot list a user's licenses, so gam info user probes every SKU GAM knows, one call each. Put this command's output into license_skus in gam.cfg and info user gets dramatically faster and stops eating quota.",
    ],
    variant: "gam7",
  },
  ...
  },
  {
    ...
    notes: [
      ...
      "Pick the reason honestly: deprovision_retiring_device, deprovision_same_model_replace, deprovision_different_model_replace or deprovision_upgrade_transfer. The choice affects whether the license can be reused.",
