...
export const meta: ToolMeta = {
  ...
  copy: {
    what: "Reads a position written almost any way and shows it in every other notation at once. It accepts decimal degrees, degrees with minutes and seconds, degrees with decimal minutes, UTM, MGRS, Plus Codes, geohashes, geo URIs and pasted map links, then returns decimal degrees, DMS, DDM, UTM, MGRS, a Plus Code, a geohash, a geo URI and ready to open map links. The UTM and MGRS maths is WGS84 with the Kruger series, so it stays accurate to well under a centimetre and handles the southwest Norway and Svalbard zone exceptions. Give it two positions separated by a semicolon or a blank line and it adds the great circle distance and the initial bearing.",
