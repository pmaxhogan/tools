...
export const meta: ToolMeta = {
  ...
  searchTerms: [
    ...
    "special symbol finder",
    "arrow character copy paste",
    "unicode name lookup",
  ],
  input: "text/plain",
  ...
  copy: {
    ...
    how: 'Type what you are looking for ("left arrow", "em dash", "greek", "rupee") and the glyph grid filters as you type; multi-word queries match all the words, so "left arrow" finds "leftwards arrow". Narrow it further with the category buttons, or leave the search empty to browse a whole category. Click any glyph to copy the character straight to your clipboard; the detail strip underneath names the last one you picked and carries separate copy buttons for the character and its HTML entity. Paste a character into the search box to identify it.',
