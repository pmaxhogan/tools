...
export const meta: ToolMeta = {
  ...
  searchTerms: [
    ...
    "cp2102 serial",
    "ftdi terminal",
    "putty alternative browser",
    "screen command alternative",
    "microcontroller console",
    "baud rate terminal",
    "usb to serial monitor",
    "raspberry pi pico console",
    "esp8266 serial log",
    "web serial monitor chrome",
    "flash progress serial log",
    "microcontroller boot log",
  ],
  input: "none",
