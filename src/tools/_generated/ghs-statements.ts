...
export const PICTOGRAMS: GhsPictogram[] = [
  { code: "GHS01", name: "Exploding Bomb", hazardClass: "Explosives" },
  { code: "GHS02", name: "Flame", hazardClass: "Flammables" },
  { code: "GHS03", name: "Flame Over Circle", hazardClass: "Oxidizers" },
  { code: "GHS04", name: "Gas Cylinder", hazardClass: "Compressed Gases" },
  { code: "GHS05", name: "Corrosion", hazardClass: "Corrosives" },
  { code: "GHS06", name: "Skull and Crossbones", hazardClass: "Acute Toxicity" },
  { code: "GHS07", name: "Exclamation Mark", hazardClass: "Irritant" },
...
export const P_STATEMENTS: Record<string, string> = {
  ...
  "P322": "Specific treatment is urgent (see information on the safety datasheet)",
  "P323": "Specific measures (see information on the safety datasheet).",
  "P330": "Rinse mouth.",
