...
export const meta: ToolMeta = {
  ...
  searchTerms: [
    ...
    "day length calculator by date",
    "golden hour calculator by city",
  ],
  input: "text/plain",
