...
export const meta: ToolMeta = {
  ...
  copy: {
    ...
    why: 'The popular JSON and JWT sites wrap a one-line transform in ad slots, cookie walls and a "paste your token here" box that ships your credentials to their server. A JWT usually contains a live session identity — pasting one into a remote form is a real leak. Here the transform runs in your browser, your inputs never leave your device, there is no size cap, and the page keeps working offline after first load.',
    faq: [
      {
