...
<template>
  <div class="flex flex-col gap-4">
    ...
    <div class="flex flex-col gap-4 rounded-[18px] border bg-card p-5 shadow-[var(--sh-sm)] sm:p-6">
      ...
      <div
        v-if="!device && knownDevices.length"
        class="flex flex-wrap items-center gap-2"
      >
        <span class="text-xs font-semibold tracking-[0.04em] text-muted-foreground uppercase">Already allowed</span>
        <Button
    ...
    >
      ...
      <div class="flex flex-col gap-2">
        <span class="text-xs font-semibold tracking-[0.04em] text-muted-foreground uppercase">Collection tree</span>
        <pre
    ...
    >
      <div class="flex flex-wrap items-center gap-3">
        ...
        <div
          v-if="inputReportIds.length > 1"
          class="flex items-center gap-2"
        >
          <Label
            for="hid-report-filter"
      ...
      >
        ...
        >
          ...
          <dl
            v-else
            class="mt-2 grid grid-cols-[minmax(0,1fr)_auto] gap-x-3 gap-y-0.5 text-xs"
          >
            <template
              v-for="(field, i) in entry.fields"
              :key="i"
            >
